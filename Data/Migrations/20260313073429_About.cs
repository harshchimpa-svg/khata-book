    ...
    public partial class About : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DiteTypes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PaymentLogs_Customers_CustomerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GymProducts_Categorys_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Dites", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Dites_DiteTypes_DietTypeId",
                        column: x => x.DietTypeId,
                        principalTable: "DiteTypes",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Exercises_DiteTypes_DietTypeId",
                        column: x => x.DietTypeId,
                        principalTable: "DiteTypes",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SaleProducts_GymProducts_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DietDocuments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DietDocuments_Dites_DietId",
                        column: x => x.DietId,
                        principalTable: "Dites",
                        principalColumn: "Id");
                });

            migrationBuilder.CreateTable(
                name: "ExerciseDocuments",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExerciseDocuments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExerciseDocuments_Exercises_ExerciseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DietDocuments_DietId",
                table: "DietDocuments",
                column: "DietId");

            migrationBuilder.CreateIndex(
                name: "IX_Dites_DietTypeId",
                table: "Dites",
                column: "DietTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_ExerciseDocuments_ExerciseId",
                table: "ExerciseDocuments",
                column: "ExerciseId");

            migrationBuilder.CreateIndex(
                name: "IX_Exercises_DietTypeId",
                table: "Exercises",
                column: "DietTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_GymProducts_CategoryId",
                table: "GymProducts",
                column: "CategoryId");
